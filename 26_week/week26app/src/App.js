...
import './assets/superhero';
import Superhero from './assets/superhero';
    ...
    <div className="App">
      {
        articles.map((article) =>
          <Superhero superhero={article.superhero} src={article.src} universe={article.universe} alter_ego={article.alter_ego} occupation={article.occupation} friends={article.friends} superpowers={article.superpowers} more={article.more}></Superhero>
        )
      }
    </div>
  );
